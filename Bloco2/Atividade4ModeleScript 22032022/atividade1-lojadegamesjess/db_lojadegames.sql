...
-- -----------------------------------------------------
-- Table `db_loja_games`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_loja_games`.`usuario` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  INDEX `fk_tb_produtos_usuario1_idx` (`usuario_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_produtos_tb_categorias`
    FOREIGN KEY (`tb_categorias_id`)
    REFERENCES `db_loja_games`.`tb_categorias` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_produtos_usuario1`
    FOREIGN KEY (`usuario_id`)
    REFERENCES `db_loja_games`.`usuario` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
